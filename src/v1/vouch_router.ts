...
vouchRouter.get(
  "/providers/validationType/:validation_type",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/providers/validationType/{validation_type}"
    );
...
vouchRouter.post("/validationtx/create", async (req, res) => {
  // tslint:disable-next-line:no-console
  console.info(
    `Executing: /v1/vouch_router/validationtx/create ${JSON.stringify(
      req.body
    )}`
  );
...
vouchRouter.post("/contact", async (req, res) => {
  // tslint:disable-next-line:no-console
  console.info(
    `Executing: /v1/vouch_router/contact ${JSON.stringify(req.body)}`
  );
...
vouchRouter.get("/validationtx/provider_id/:provider_id", async (req, res) => {
  // tslint:disable-next-line:no-console
  console.info(
    "Executing: /v1/vouch_router/validationtx/provider_id/{provider_id}"
  );
...
vouchRouter.get(
  "/validationtx/confirmation_id/:confirmation_id",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/validationtx/confirmation_id/{confirmation_id}"
    );
...
vouchRouter.get(
  "/validationtx/count/provider_id/:provider_id",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/validationtx/count/provider_id/{provider_id}"
    );
...
vouchRouter.get(
  "/validationtx/provider_did/:provider_did",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/validationtx/provider_did/{provider_did}"
    );
...
vouchRouter.post(
  "/validationtx/is_saved/confirmation_id/:confirmation_id",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/validationtx/is_saved/confirmation_id/{confirmation_id}"
    );
...
vouchRouter.post(
  "/validationtx/approve/confirmation_id/:confirmation_id",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/approve/confirmation_id/{confirmation_id}"
    );
...
vouchRouter.post(
  "/validationtx/reject/confirmation_id/:confirmation_id",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/reject/confirmation_id/{confirmation_id}"
    );
...
vouchRouter.post(
  "/validationtx/cancel/confirmation_id/:confirmation_id",
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      "Executing: /v1/vouch_router/cancel/confirmation_id/{confirmation_id}"
    );
