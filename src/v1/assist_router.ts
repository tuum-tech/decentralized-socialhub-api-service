...
assistRouter.get(
  '/didtx/confirmation_id/:confirmation_id',
  async (req, res) => {
    // tslint:disable-next-line:no-console
    console.info(
      'Executing: /v2/assist_router/didtx/confirmation_id/{confirmation_id}'
    )
...
assistRouter.get('/documents/crypto_name/:crypto_name', async (req, res) => {
  // tslint:disable-next-line:no-console
  console.info(
    'Executing: /v1/assist_router/documents/crypto_name/{crypto_name}'
  )
