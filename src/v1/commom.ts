...
export async function sendMail(from: string, subject : string, to: string, text: string, html: string) {
...
export async function sendCreateUserVerificationEmail(email : string, code: string){
