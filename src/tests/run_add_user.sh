curl -X POST -H 'Authorization: profile-api-secret-key' -H 'Content-Type: application/json' -H "Accept: application/json" -d '{
            ...
            "name": "John Doe", "email": "tets", "status": "CONFIRMED", "code": "sdsd", "did": "dfsd", "hiveHost": "localhost", "avatar": "ahjbabha",
          ...
          }' http://localhost:8000/v1/tuumvault_router/scripting/run_script
