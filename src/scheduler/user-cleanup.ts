...
import { getHiveClient, getNonAnonymousClient } from "../v1/commom";
...
export function scheduleUsersCleanUp() {
    ...
    cron.schedule('*/10 * * * *', async () => {
        ...
        const response : IRunScriptResponse<any> =  await hiveClient.Scripting.RunScript<any>(deleteScript as IRunScriptData);
